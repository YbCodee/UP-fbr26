...
namespace WinFormsApp1
{
    ...
    {
        string cn = @"Data Source=.\SQLEXPRESS;Initial Cata-log=ybshoes;Integrated Security=True;TrustServerCertificate=True";
        int? _id;
        string _img = "";
        public Form3(int? id)
        {
            ...
            try
            {
                using (SqlConnection c = new SqlConnection(cn))
                {
                    ...
                    if (_id == null)
                        sql = @"
INSERT INTO Product
(arti-cle,name,unitid,price,providerid,producerid,categoryid,discount,amountidstock,description,photo)
VALUES
...
WHERE id=@id";
                    ...
                    cmd.Parameters.AddWithValue("@price", deci-mal.Parse(txtPrice.Text));
                    cmd.Parameters.AddWithValue("@stock", int.Parse(txtStock.Text));
                    cmd.Parameters.AddWithValue("@description", txtDescrip-tion.Text);
